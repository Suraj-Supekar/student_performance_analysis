...
if "subjects" not in st.session_state:
    st.session_state.subjects = [
        {"name": "Data Science & Big Data Analytics", "marks": 0, "total": 100},
        {"name": "Web Technology", "marks": 0, "total": 100},
        {"name": "Machine Learning", "marks": 0, "total": 100},
        {"name": "Elective II – Cloud Computing", "marks": 0, "total": 100},
    ]
...
with tab1:
    ...
    with col2:
        ...
        branch = st.selectbox(
            "Branch",
            ["CSE", "IT", "Computer Science & Engg (Data Science)", "ENTC", "MECH", "CIVIL"],
            index=[
...
# ==================================================
# TAB 3 – POWER BI STYLE DASHBOARD (UPDATED)
# ==================================================
with tab3:
    ...
    avg_perc = round(df['percentage'].mean(),2)
    ...
    with k2:
        st.markdown(f"""
        <div class="kpi-card">
        <div class="kpi-title">📈 Avg Percentage</div>
        <div class="kpi-value">{avg_perc}%</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with k3:
        st.markdown(f"""
        <div class="kpi-card">
        <div class="kpi-title">⚠️ High Risk Students</div>
    ...
    with col_left:
        st.subheader("🏫 Branch-wise Students")
    ...
    st.dataframe(perf_summary, width="stretch")
    ...
    if search:
        search_df = search_df[
            search_df["student_name"].str.contains(search, case=False, na=False) |
            search_df["roll_no"].str.contains(search, case=False, na=False)
        ]

    # ==================================================
    # 📋 ALL STUDENTS TABLE (NEW)
    # ==================================================
    ...
    # ==================================================
    # DOWNLOAD CSV (NEW PRO FEATURE)
    # ==================================================
    csv = df.to_csv(index=False).encode("utf-8")

    st.download_button(
        "⬇️ Download All Students Data (CSV)",
        csv,
        "students_data.csv",
        "text/csv"
    )
